      ...
      <div class="container-fluid">
        <div class="page-header">
          <h1 class="text-titles">
            <i class="zmdi zmdi-account zmdi-hc-fw"></i> Gestionar<small>Hoteles</small>
          </h1>
        </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-xs-12">
            ...
            <li ><a onclick="cargaSelectCiudades()" href="#modalUsuarios" data-toggle="tab" data-dismiss="modal">NUEVO</a></li>
                                    ...
                                    <div class="modal-body">
                                      <input type="hidden" name="idHotel" id="idHotel"/>
                                        ...
                                        <div class="form-group">
                                          <label for="nombre" class="control-label">HOTEL</label>
                                          <input type="text" name="nombre" id="nombre" class="form-control" required/>
                                        </div>
                                       
                                        <div class="form-group">
                                        <label for="ciudad" class="control-label">Ciudades</label>
