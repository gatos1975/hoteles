      ...
      <div class="container-fluid">
        <div class="page-header">
          <h1 class="text-titles">
            <i class="zmdi zmdi-account zmdi-hc-fw"></i> Gestionar<small>Habitaciones</small>
          </h1>
        </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-xs-12">
            ...
            <li ><a onclick="cargaSelectHoteles()" href="#modalUsuarios" data-toggle="tab" data-dismiss="modal">NUEVO</a></li>
                                  ...
                                  <form id="usuarios_form" >
                                    <div class="modal-body">
                                      <input type="hidden" name="idhabitacion" id="idhabitacion"/>
                                        ...
                                        <div class="form-group">
                                          <label for="numero" class="control-label">NUMERO DE HABITACION</label>
                                          <input type="text" name="numero" id="numero" class="form-control" required/>
                                        </div>
                                        
                                        <div class="form-group">
                                          <label for="descripcion" class="control-label">DETALLE DE LA HABITACION</label>
