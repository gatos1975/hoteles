      ...
      <div class="container-fluid">
        <div class="page-header">
          <h1 class="text-titles">
            <i class="zmdi zmdi-account zmdi-hc-fw"></i> RESERVACIONES<small>DE HOTEL</small>
          </h1>
        </div>
        <p class="lead">LISTADO DE HOTELES Y HABITACIONES DISPONIBLES</p>
      </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-xs-12">
            ...
            <li ><a onclick="cargaSelectHoteles()" href="#modalUsuarios" data-toggle="tab" data-dismiss="modal">RESERVAR HOTEL</a></li>
                                  ...
                                  <form id="usuarios_form" >
                                    <div class="modal-body">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          <label for="fentrada" class="control-label">FECHA ENTRADA</label>
                                          <input type="date" name="fentrada" id="fentrada" class="form-control" required/>
                                        </div>

                                        <div class="form-group">
                                          <label for="fsalida" class="control-label">FECHA SALIDA</label>
                                          <input type="date" name="fentrada" id="fsalida" class="form-control" required/>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                          <button type="submit" class="btn btn-primary">ENVIAR RESERVASION </button>
